    ...
    <div className='min-h-40 w-full p-3 sm:p-6 bg-[#61A986]'>
      ...
      <div className='flex flex-col lg:flex-row lg:justify-between gap-4 lg:gap-0'>
        ...
        <div className='flex-1 max-w-none lg:max-w-2xl'>
          <p className={`text-lg sm:text-xl lg:text-2xl text-[#F6F8F6] font-bold ${out_fit.className} dark:text-[#000000] leading-tight`}>
            "Forms that hustle, so you don't have to."
          </p>
          <p className={`text-lg sm:text-xl font-bold mt-2 sm:mt-4 ${out_fit.className} text-[#F6F8F6] dark:text-[#000000]`}>
            F.O.R.M
          </p>
          {/* Navigation links */}
        ...
        <div className='flex justify-start lg:justify-end lg:mt-7'>
          <AuthBtn pos='footer'/>
        </div>
      </div>
