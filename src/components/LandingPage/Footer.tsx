    ...
    <div className="min-h-40 w-full p-3 sm:p-6 bg-[#61A986]" id="contact">
      ...
      <div className="flex flex-col lg:flex-row lg:justify-between gap-4 lg:gap-0 w-full">
        ...
        <div className="flex justify-end mt-20">
          <p className="text-base sm:text-lg font-semibold text-[#F6F8F6] dark:text-[#000000]">
      ...
      {/* Divider */}
      <hr className="mt-0 sm:mt-2 border-0 h-[2px] bg-[#F6F8F6] w-full mb-3 dark:bg-[#191719]" />

      {/* Bottom section - Copyright and social icons */}
      <div className="flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-0 mx-0 sm:mx-4">
        {/* Copyright */}
        <div className="flex items-center">
          <Copyright className="w-7 h-7 sm:w-8 sm:h-8 text-[#F6F8F6] dark:stroke-[#000000]" />
          <span className="ml-1 text-xl sm:text-sm text-[#F6F8F6] dark:text-[#000000]">
            2025 F.O.R.M
          </span>
        </div>
        ...
        <div className="flex justify-center gap-4 sm:gap-5 items-start">
          ...
          >
            <Image
              ...
              width={28}
              height={28}
              className="w-7 h-7 sm:w-8 sm:h-8 top-0.5 stroke-none fill-[#F6F8F6] dark:stroke-none dark:fill-[#000000] hover:opacity-80 cursor-pointer transition-opacity"
            />
          </a>
          <a
            ...
            rel="noopener noreferrer"
          >
            <YoutubeIcon className="w-7 h-7 sm:w-8 sm:h-8 text-[#F6F8F6] dark:stroke-[#000000] hover:opacity-80 cursor-pointer transition-opacity" />
          </a>
