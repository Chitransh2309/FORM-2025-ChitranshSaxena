  ...
  return (
    <div className="bg-[#56A37D] w-full h-screen flex flex-col px-6 py-6 dark:text-white dark:bg-[#414141]">
      ...
      <div className="flex items-center gap-3 mb-8">
        ...
        <h1 className="text-2xl font-bold">FormSpace</h1>
      </div>
      ...
      <div className="flex-1 space-y-2">
        <button className={linkClass("myForms")} onClick={() => setSelected("myForms")}>
          <GrDocument size={20} />
          My Forms
        </button>

        <button className={linkClass("shared")} onClick={() => setSelected("shared")}>
          <TbShare3 size={20} />
          Shared with me
        </button>

        <button className={linkClass("starred")} onClick={() => setSelected("starred")}>
          <FaRegStar size={20} />
          Starred
        </button>

        <button className={linkClass("trash")} onClick={() => setSelected("trash")}>
          <LuTrash2 size={20} />
          Trash
        </button>
      </div>
