        ...
        <div className="flex items-center gap-2">
          ...
          {showDialog && (
            <div className="fixed inset-0 z-50 flex items-center justify-center">
              <div className="bg-white border-2 border-gray-800 rounded-xl shadow-2xl w-[20rem] sm:w-[42rem] max-w-full p-8 animate-pop-in dark:bg-[#353434] dark:border-gray-500">
